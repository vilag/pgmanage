...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Montserrat+Alternates:wght@100;300&family=Montserrat:wght@500&display=swap"
    rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@1,100&family=Oswald:wght@300&display=swap"
    rel="stylesheet">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        ...
        <div class="left_col scroll-view">
          ...
          <div style="position: fixed; margin-top: 30%; margin-left: 90%;" id="globo_mensajes_notif">
            <a href="# " onclick="listar_controles_mensajes();" class="dropdown-toggle" data-toggle="dropdown"
              role="button" aria-expanded="false" id="edit_fecha">
              <div
                style=" width: 50px; height: 50px; background-color: #fff;  box-shadow: 0px 0px 80px rgb(0,0,0,0.7); border-radius: 50% 50%; padding-left: 10px; padding-top: 8px;">
          ...
          <div id="globo_notif"
            style="position: fixed; width: 30px; height: 30px; background-color: #000; margin-top: 29%; margin-left: 92%; box-shadow: 0px 0px 80px rgb(0,0,0,0.7); border-radius: 50% 50%; padding-left: 12px; padding-top: 5px;">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                if (($_SESSION['idusuario'] >= 1 AND $_SESSION['idusuario'] <= 6) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 14) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] == 23) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 25) OR ($_SESSION['idusuario'] == 26) OR ($_SESSION['idusuario'] == 28)) {
                  echo '    
                ...
                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] >= 4 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 11) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] == 23) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 26)) {
                  echo '     
                ...
                <?php
                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 11) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] == 10) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] == 5) OR ($_SESSION['idusuario'] == 4) OR ($_SESSION['idusuario'] == 23) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 27)) {
                ...
                if (($_SESSION['idusuario'] >= 1 AND $_SESSION['idusuario'] <= 6) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 25) OR ($_SESSION['idusuario'] == 26) OR ($_SESSION['idusuario'] == 28)) {
                  echo '    
                ...
                if (($_SESSION['idusuario'] >= 1 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 9) OR ($_SESSION['idusuario'] >= 11 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 26) OR ($_SESSION['idusuario'] == 28)) {
                  echo '
                ...
                if (($_SESSION['idusuario'] >= 1 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 25) OR ($_SESSION['idusuario'] == 26) OR ($_SESSION['idusuario'] == 28)) {
                  echo '     
                ...
                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] >= 4 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 22) OR ($_SESSION['idusuario'] >= 14 AND $_SESSION['idusuario'] <= 21) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 25)) {
                  echo '    
                ...
                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] >= 4 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 9) OR ($_SESSION['idusuario'] >= 11 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 24)) {
                  echo '
                                     <li><a href="seguim_op.php">Seguimiento</a>
                          ';
                }

                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] >= 4 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 9) OR ($_SESSION['idusuario'] >= 11 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14)) {
                  echo '
                ...
                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28)) {
                  echo '
                                   <li><a href="correcciones.php">Correcciones</a>
                        ';
                }

                if (($_SESSION['idusuario'] == 1) OR ($_SESSION['idusuario'] == 28) OR ($_SESSION['idusuario'] >= 4 AND $_SESSION['idusuario'] <= 5) OR ($_SESSION['idusuario'] >= 7 AND $_SESSION['idusuario'] <= 12) OR ($_SESSION['idusuario'] == 14) OR ($_SESSION['idusuario'] == 18) OR ($_SESSION['idusuario'] >= 22) OR ($_SESSION['idusuario'] == 24) OR ($_SESSION['idusuario'] == 25)) {
                  echo '     
                                  </ul>
                                </li>
                          ';
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="ajax/usuario.php?op=salir"><i class="fa fa-sign-out pull-right"></i>
                    Cerrar sesión</a>
                </div>
              </li>
              ...
              <li role="presentation" class="nav-item dropdown open" id="li_notif" style="margin-right: 20px;">
                <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown2_" data-toggle="dropdown"
                  aria-expanded="false" onclick="listar_mensajes();">
                  <i class="fa fa-comments-o"></i>
                  <span class="badge bg-green" id="num_mensajes_chat"></span>

                </a>
                <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown2_"
                  id="ul_mensajes">
                </ul>
              </li>
      ...
      <script type="text/javascript">
        ...
        if ((idusuario >= 15 && idusuario <= 22) || idusuario == 28) {
        ...
        function contar_mensajes() {
          ...
          if ((idusuario >= 1 && idusuario <= 14) || idusuario == 28) {
      ...
      <style type="text/css">
        .tamano {
          ...
          width: 400px;
          margin-right: 530px;
          box-shadow: 10px -10px 40px rgb(0, 0, 0, 0.1), -10px -10px 40px rgb(0, 0, 0, 0.1);
        }
      </style>
      <div id="caja_chat" class="compose tamano col-md-6">
        ...
        <div class="col-md-12 col-sm-12"
          style="height:350px; width: 500px; position: relative; word-wrap: break-word; overflow: scroll;" id="box_chat"
          onscroll="mover_scroll();">
        ...
        <div class="compose-footer" style="margin-top: 70%;">
          <div class="col-md-10 col-sm-10">
            ...
            <a href="#" id="boton_down" onclick="bajar_scroll();">
              <div
                style="width: 35px; height: 35px; background-color: #4B5F71; position: absolute; margin-top: -70px; margin-left: 310px; border-radius: 50% 50%;">
                <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"
                  style="color: #fff; margin-left: 10px; margin-top: 10px;"></span>
              </div>
            </a>
          ...
          <div class="col-md-2" style="height: 85px; border-radius: 10px 10px; padding-top: 25px; padding-right: 10px;">
            <a href="#" style="color: #fff; font-size: 20px;" onclick="guardar_mensaje_chat();"><img
                src="images/iconos/send.png" width="100%"></a>
          </div>
