              ...
              <div class="x_title">
                ...
                <div style="padding-top: 10px;">
                  <ul class="nav panel_toolbox" style="float: left;">
                    <li>
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"
                        style="color: #73879C; margin-right: 30px; margin-top: -7px"><label id="text_estatus"
                          style="font-size: 12px;">Filtrar:</label></a><br>
                    ...
                    <li>
                      ...
                      <select class="form-control" id="selec_busqueda" onchange="selec_tipo_busqueda();"
                        style="border-style: none; width: 150px; font-size: 12px; margin-top: -5px;">
                    ...
                    <li style=" padding-left: 10px;" id="li_buscar_control">
                      <input id="input_buscar" type="number" style="border-style: none; border-bottom: groove;"
                        placeholder="No. Control"
                        onkeypress="if (event.keyCode==13) {event.returnValue=false;buscar_control();}">

                    </li>

                    <li id="li_buscar_btns2">
                      <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="top"
                        title="Buscar control" onclick="buscar_control();"><span class="glyphicon glyphicon-search"
                          aria-hidden="true" style="color: black;"></span></button>
                      <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="Limpiar"
                        onclick="init();" style="margin-left: -5px;"><i class="fa fa-refresh"></i></button>
                    </li>

                    <li style=" padding-left: 10px;" id="li_buscar_fecha">
                      <input type="date" class="" id="fecha1_consul" style="border-style: none; border-bottom: groove;"
                        onchange="valid_datos_fecha();">
                      <label> - </label>
                      <input type="date" class="" id="fecha2_consul"
                        style="border-style: none; border-bottom: groove; margin-right: 20px;"
                        onchange="valid_datos_fecha();">
                    </li>
                    <li style=" padding-left: 10px;" id="li_buscar_nombre">
                      <input type="text" id="nombre_cliente" placeholder="Nombre de cliente"
                        style="border-style: none; border-bottom: groove;" onkeyup="valid_nom_cli();">
                      <input type="hidden" id="valor_consulta">

                    </li>
                    <li style=" padding-left: 10px;" id="li_buscar_btns">
                      <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="Buscar"
                        onclick="buscar_valores();"><span class="glyphicon glyphicon-search" aria-hidden="true"
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li>
                      <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="top"
                        title="Vales de salida de almacén" onclick="abrir_vale();" style="margin-right: 5px;"><i
                          class="fa fa-file-text-o"></i></button>
                    </li>
                    <li>
                      <button onclick="abrir_terminados();" id="btn_terminados" class="btn" type="button"
                        style="color: #fff; font-size: 15px; padding-top: 3px; margin-right: 5px;" data-toggle="tooltip"
                        data-placement="top" title="Terminados">
                        <i class="fa fa-check-circle" style="font-size: 20px; color: #037739;"></i>
                      </button>
                      <span
                        style="background: #313E46; border-width: 5px; border-style: solid; border-color: #313E46;  color: #fff; font-size: 12px; position: absolute; margin-left: -22px; margin-top: -12px; border-radius: 30px 30px; font-weight: 400;"
                        id="num_notif"></span>
                    </li>
                    <li id="btn_sin_revisar">
                      <button onclick="pedidos_atencion();" class="btn" type="button"
                        style="color: #fff; font-size: 15px; padding-top: 3px; margin-right: 5px;" data-toggle="tooltip"
                        data-placement="top" title="Sin revisar">
                        <i class="fa fa-spinner" style="font-size: 20px; color: #283C50;"></i>

                      </button>
                      <span
                        style="background: #313E46; border-width: 5px; border-style: solid; border-color: #313E46;  color: #fff; font-size: 12px; position: absolute; margin-left: -22px; margin-top: -12px; border-radius: 30px 30px; font-weight: 400;"
                        id="num_notif_ped_sr"></span>
                    </li>
                    <li id="btn_vencidos">

                      <button onclick="pedidos_vencidos();" class="btn" type="button"
                        style="color: #fff; font-size: 15px; padding-top: 3px;" data-toggle="tooltip" data-placement="top"
                        title="Pedidos vencidos">
                        <i class="fa fa-clock-o" style="font-size: 20px; color: red;"></i>
                        <i class="fa fa-warning"
                          style="margin-top: 10px; margin-left: -8px; position: absolute; font-size: 12px; color: red;"></i></button>
                      <span
                        style="background: #313E46; border-width: 5px; border-style: solid; border-color: #313E46;  color: #fff; font-size: 12px; position: absolute; margin-left: -25px; margin-top: -12px; border-radius: 30px 30px; font-weight: 400;"
                        id="num_vencidos"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="col-sm-12" style="text-align: center;" id="btn_paginado">
                      <button class="btn btn-sm btn-primary" type="button" onclick="anterior_bloque();"
                        style="font-size: 10px;" id="btn_ant_paginado">Anterior</button>
                      <button class="btn btn-sm btn-secondary" type="button" id="num_pagina"
                        style="font-size: 10px;">1</button>
                      <button class="btn btn-sm btn-primary" type="button" onclick="siguiente_bloque();"
                        style="font-size: 10px;" id="btn_sig_paginado">Siguiente</button>
                    </div>
                    <div class="col-sm-12" id="info_paginado"
                      style="text-align: center; font-size: 11px; color: #666; padding: 4px 0;"></div>
                    <div class="col-sm-12 mail_list_column" id="div_lista_pedidos"
                      style="overflow:scroll;height:1400px; width:100%;">

                    </div>
                    <div class="col-sm-12" style="text-align: center;" id="btn_paginado2">
                      <button class="btn btn-sm btn-primary" type="button" onclick="anterior_bloque();"
                        style="font-size: 10px;" id="btn_ant_paginado2">Anterior</button>
                      <button class="btn btn-sm btn-secondary" type="button" id="num_pagina2"
                        style="font-size: 10px;">1</button>
                      <button class="btn btn-sm btn-primary" type="button" onclick="siguiente_bloque();"
                        style="font-size: 10px;" id="btn_sig_paginado2">Siguiente</button>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-9 mail_view ">
                    <div class="inbox-body">
                      <div class="mail_heading row">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-11">
                            ...
                            <div class="col-md-12" style="background: #E2E2E2; border-radius: 15px 15px;">
                              ...
                              <div class="col-md-5"
                                style="  padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; height: 200px;">
                                <button id="btn_estatus_ped" type="button" class="btn btn-sm btn-dark btn-block"
                                  data-toggle="tooltip" data-placement="top" title="Cambiar estatus de pedido"
                                  onclick="abrir_seg_ped();"
                                  style="color: #fff; font-size: 12px; font-style: bold; margin-right: -10px;"></button><br>
                                <b id="tipo_pedido" style="font-size: 15px; color: #315364;"></b><br>
                                Origen: <b id="lugar" style="color: #313A4D;"></b><br>
                                CONTROL | PEDIDO | CLIENTE
                                <p style="font-size: 20px; margin-bottom: 1px; color: #313A4D;"><b id="no_control"></b> | <b
                                    id="no_pedido" style="font-size: 15px;"></b> | <b id="cliente"
                                    style="font-size: 12px; text-decoration-line: underline; color: #313A4D;"></b></p>
                              ...
                              <div class="col-md-12">
                                <div class="col-md-12">
                                  ...
                                  <p style="color: #313A4D;"><i class="fa fa-comments-o" style="font-size: 12px;"
                                      data-toggle="tooltip" data-placement="top" title="Observaciones generales"></i><b
                                      id="observ_ini" style="margin-left: 10px; font-size: 10px;"></b><a href="#"
                                      onclick="abrir_edit_observ();" style="margin-left: 10px;">(Editar observaciones)</a>
                                  </p><br>
                                  <p style="margin-top: -20px; color: #313A4D;"><i class="fa fa-truck"
                                      style="font-size: 12px;" data-toggle="tooltip" data-placement="top"
                                      title="Detalles de forma de entrega"></i><b id="detalles_form_entre_ini"
                                      style="margin-left: 10px;"></b></p>
                                </div>
                                ...
                                <ul class="wizard_steps">
                                  ...
                                  <li>
                                    <a href="#step-2" onclick="abrir_modal_fecha_modif();">
                                      <span class="step_no"><span class="glyphicon glyphicon-edit" aria-hidden="true"
                          ...
                          <div class="col-md-1"
                            style="background: #283C50; border-radius: 15px 15px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                            ...
                            <a href="" id="enlace_pedido2" onclick="abrir_rep_ped2();" target="_blank">
                              <button type="button" class="btn" data-toggle="tooltip" data-placement="top"
                                title="Imprimir pedido" style="font-size: 20px; padding-right: -10px;"><i
                                  class="fa fa-print" style="color: #fff;"></i></button>

                            </a>
                            <button id="" type="button" class="btn" data-toggle="tooltip" data-placement="top"
                              title="Descargar salidas" onclick="abrir_modal_doc_salidas();"
                              style="font-size: 20px; padding-right: -10px;"><i class="fa fa-truck"
                                style="font-size: 15px; color: #fff;"></i></button>
                            <button type="button" class="btn" data-toggle="tooltip" data-placement="top"
                              title="Historial de movimientos" onclick="listar_historial();"
                              style="font-size: 20px; padding-right: -10px;"><i class="fa fa-history"
                                style="color: #fff;"></i></button>
                            <button id="btn_edit_prod" type="button" class="btn" data-toggle="tooltip" data-placement="top"
                              title="Editar productos" onclick="abrir_edit_prod_list();"
                              style="font-size: 20px; padding-right: -10px;"><span class="glyphicon glyphicon-edit"
                                aria-hidden="true" style="color: #fff;"></span></button>
                            <button id="" type="button" class="btn" data-toggle="tooltip" data-placement="top"
                              title="Agregar documentos" onclick="abrir_documentos();"><i class="fa fa-file"
                                style="font-size: 20px; padding-right: -10px; color: #fff;"></i></button>
                        ...
                        <div class="col-md-12 col-sm-12 " id="div_prod_list_ped"
                          style="border:0px solid #e5e5e5; overflow:auto;height:auto; max-height: 400px; width: auto; max-width: 100%; margin-bottom: 20px;">
                        ...
                        <div class="col-md-12" style="background-color: #F2F9FC; padding: 30px;">
                          ...
                          <div class="col-md-12" style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-12" style="margin-top: 20px;">
                              <button id="btn_update_fact" type="button" class="btn btn-dark"
                                onclick="guardar_datos_facturacion();">Guardar datos de facturación</button>
                        ...
                        <div class="col-md-12" style="background-color: #F2FCF6; padding: 30px;">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="margin-top: 20px;">
                              <button id="btn_update_ent" type="button" class="btn btn-dark"
                                onclick="guardar_datos_entrega();">Guardar datos de entrega</button>
                        ...
                        <div class="col-md-12" style="margin-top: 20px;">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                              ...
                              <label id="idpedido2"
                                style="visibility: hidden;"><?php $pedido = ($_GET['pedido']);
                                echo "$pedido"; ?></label>
                            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="col-md-12 col-sm-12"
              style="border:0px solid #e5e5e5; overflow:scroll;height:auto; max-height: 300px;">
        ...
        <div class="modal-content" style="border:0px solid #e5e5e5; overflow:scroll;height:100vh;">
          ...
          <div class="modal-body">
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <div class="col-md-12 col-sm-12" id="div_quitar"
                style="border:0px solid #e5e5e5; overflow:scroll;max-height: 400px;">
                <table id="tbl_productos_pedido_exist" class="table table-hover">
                </table>
              </div>
              <div class="col-md-12 col-sm-12" id="div_cambiar"
                style="border:0px solid #e5e5e5; overflow:scroll;max-height: 400px;">
              ...
              <div class="col-md-12 col-sm-12" id="div_editar"
                style="border:0px solid #e5e5e5; overflow:scroll;max-height: 400px;">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body" style="border:0px solid #e5e5e5; overflow:scroll;height:auto; max-height: 400px;">
            ...
            <div class="col-md-12 col-sm-12" id="new_doc">
              ...
              <div class="col-md-12 col-sm-12">
                ...
                <form name="formulario-envia_comprobante" id="formulario-envia_comprobante" enctype="multipart/form-data"
                  method="post">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" id="regresar_total"
              onclick="abrir_terminados();">Regresar</button>
          ...
          <div class="modal-body" style="border:0px solid #e5e5e5; overflow:scroll;height:auto; max-height: 500px;">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="">
              ...
              <div class="form-group col-md-12 col-sm-12" align="">
                ...
                <div class="form-group col-md-2 col-sm-2" align="right">
                  <button type="button" class="btn" title="Nuevo vale" onclick="nuevo_vale();"><i
              ...
              <div class="form-group col-md-12 col-sm-12" align="">
                ...
                <div class="form-group col-md-12 col-sm-12">
                  <div class="form-group col-md-3 col-sm-3" id="box_vales_salida"
                    style="border:0px solid #e5e5e5; overflow:scroll;height: 420px;">
                  ...
                  <div class="form-group col-md-9 col-sm-9" id="">
                    ...
                    <div class="form-group col-md-6 col-sm-6" id="btns_vale">
                      <button type="button" class="btn" onclick="solicitar_vale()" style="margin-left: -15px;"
                        id="btn_solic_vale"><i class="fa fa-check"></i></button>

                      <a href="" id="enlace_vale_alm" onclick="abrir_vale_alm();" target="_blank">
                        <button type="button" class="btn" data-toggle="tooltip" data-placement="top"
                          title="Imprimir vale de almacén" style="margin-left: -10px;" id="btn_abrir_imp_vale"><span
                            class="glyphicon glyphicon-print" aria-hidden="true"></span></button>

                      </a>
                      <button type="button" class="btn" onclick="borrar_vale();" id="btn_borrar_vale"><i class="fa fa-trash"
                          style="margin-left: -10px;"></i></button>
                      <button type="button" class="btn" onclick="archivar_vale()" id="btn_archivar_vale"><i
                          class="fa fa-archive" style="margin-left: -10px;"></i></button><br>

                      <input type="checkbox" id="check_prio" onchange="estab_prior();" style="margin-bottom: 20px;" /> <b
                        style="color: black;">Urgente</b>
