...
function set_fecha_hora_entr() {
	...
	if (fecha_entrega_etiq == "" || idusuario == 1 || idusuario == 28 || idusuario == 11) {
...
function contar_sin_coment_venc() {
	$.post("ajax/diseno.php?op=contar_sin_coment_venc", function (data, status) {
		...
		if (data.num_vencidos_sincoment > 0) {
			...
			if (idusuario == 4 || idusuario == 1 || idusuario == 28 || idusuario == 5 || idusuario == 7 || idusuario == 8 || idusuario == 9 || idusuario == 10 || idusuario == 11 || idusuario == 12 || idusuario == 14 || idusuario == 23) {
