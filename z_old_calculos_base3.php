...
// $sql11 = "SELECT idpg_pedidos as id_ini FROM pg_pedidos WHERE estatus2=1 AND estatus<>'ENTREGADO' AND estatus<>'CANCELADO' AND estatus<>'0' ORDER BY fecha_pedido ASC LIMIT 1";
// $result11 = mysqli_query($conn, $sql11);
// $row = mysqli_fetch_assoc($result11);
// $id_ini = $row['id_ini'];

// $sql12 = "SELECT idpg_pedidos as id_fin FROM pg_pedidos WHERE estatus2=1 AND estatus<>'ENTREGADO' AND estatus<>'CANCELADO' AND estatus<>'0' ORDER BY fecha_pedido DESC LIMIT 1";
