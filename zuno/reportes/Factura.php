...
// Client address
function addClientAdresse( $coto,$lote,$numero,$domicilio,$folio,$email,$telefono )
{
	$r1     = $this->w - 180;
	$r2     = $r1 + 68;
	$y1     = 40;
	$this->SetXY( $r1, $y1);
	$this->SetFont( "Arial", "B", 10);
	$this->MultiCell( 60, 4, "Vivienda");
	$this->SetXY( $r1, $y1+5);
	$this->SetFont( "Arial", "", 10);
	$this->MultiCell( 150, 4, $coto);
	$this->SetFont( "Arial", "", 10);
	$this->MultiCell( 150, 4, $lote);
	$this->SetFont( "Arial", "", 10);
	$this->MultiCell( 150, 4, $numero);
	$this->SetXY( $r1, $y1+10);
	$this->MultiCell( 150, 4, $domicilio);
	$this->SetXY( $r1, $y1+15);
	$this->MultiCell( 150, 4, $folio);
	$this->SetXY( $r1, $y1+20);
